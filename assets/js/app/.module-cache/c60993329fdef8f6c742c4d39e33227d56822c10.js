                ...
                return (
                    React.createElement("article", {className: "box post post-excerpt"}, 
                        ...
                        React.createElement("div", {className: "info"}, 
                            React.createElement("span", {className: "date"}, React.createElement("span", {className: "month"}, month[parsedDate.getMonth()], React.createElement("span", null, "y")), " ", React.createElement("span", {className: "day"}, parsedDate.getDate()), React.createElement("span", {className: "year"}, ", ", parsedDate.getFullYear())), 
