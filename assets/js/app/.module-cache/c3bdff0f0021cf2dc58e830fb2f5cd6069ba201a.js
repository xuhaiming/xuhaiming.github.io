define(['react', 'jquery', 'skel', 'director', 'scrolly', 'scrollzer', 'util', 'main'],
                    ...
                    React.createElement("section", {id: "header"}, 
                        ...
                        React.createElement("footer", null, 
                            React.createElement("ul", {className: "icons"}, 
                                React.createElement("li", null, React.createElement("a", {href: "#", className: "icon fa-twitter"}, React.createElement("span", {class: "label"}, "Twitter"))), 
                                React.createElement("li", null, React.createElement("a", {href: "#", className: "icon fa-facebook"}, React.createElement("span", {class: "label"}, "Facebook"))), 
                                React.createElement("li", null, React.createElement("a", {href: "#", className: "icon fa-instagram"}, React.createElement("span", {class: "label"}, "Instagram"))), 
                                React.createElement("li", null, React.createElement("a", {href: "#", className: "icon fa-github"}, React.createElement("span", {class: "label"}, "Github"))), 
                                React.createElement("li", null, React.createElement("a", {href: "#", className: "icon fa-envelope"}, React.createElement("span", {class: "label"}, "Email")))
                            )
                        )
                    ), 
